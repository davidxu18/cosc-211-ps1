...
public class ArraySimpleListOne<E> implements SimpleList<E> {
     ...
     */
    public ArraySimpleListOne() {
	// call the constructor that takes a single argument
     ...
     */
    public ArraySimpleListOne(int initialCapacity) {
