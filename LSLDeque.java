 ...
 * <code>LinkedSimpleList</code>. Observe that all of the operations
...
public class LSLDeque<E> implements SimpleDeque<E> {
    private SimpleList<E> list = new LinkedSimpleList<E>();
